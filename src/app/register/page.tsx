...
const FacebookIcon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="url(#register-fb-grad-unique)"
      d="M24,4C12.954,4,4,12.954,4,24s8.954,20,20,20s20-8.954,20-20S35.046,4,24,4z"
    ></path>
    <path
      fill="#fff"
      d="M26.707,26.707v11.729h5.895V26.707h4.228l0.58-4.885h-4.808v-2.883c0-1.428,0.395-2.399,2.444-2.399h2.583v-4.364c-0.445-0.059-1.979-0.19-3.757-0.19c-3.717,0-6.257,2.272-6.257,6.425v3.411h-4.25v4.885h4.25V26.707z"
    ></path>
  </svg>
);
        ...
        <main className="container mx-auto flex flex-col items-center justify-center px-4 flex-grow mb-16">
          <Card className="w-full max-w-md">
            <CardHeader>
              ...
              <CardDescription>
                Start planning your celebrations with SimpliPlan.
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <div className="mt-8 max-w-md w-full text-center p-4 rounded-lg bg-muted/50 border">
            ...
            <p className="text-xs text-muted-foreground mt-2">
              We collect only what's needed to create your account and save your
              plans. Your data is yours—we will never sell it. Everything is
              securely stored using Google's trusted services, and you are
              always in control of your information. For full details, please
              read our{" "}
              <Link href="/privacy" className="underline">
                Privacy Policy
              </Link>
