      ...
      <div className="bg-background shadow-2xl min-h-full container mx-auto flex flex-col">
        ...
        <main className="container mx-auto px-4 flex-grow my-16">
          <article className="prose lg:prose-xl max-w-none mx-auto">
            ...
            <p><strong>Responsible Party:</strong> SimpliPlan</p>
            <p><strong>Country:</strong> South Africa</p>
            <p><strong>Contact Email:</strong> privacy@simpliplan.co.za</p>
            <p>SimpliPlan is the responsible party for personal information processed through the SimpliPlan website and application.</p>

            <h2 className="text-2xl font-bold font-headline mt-8 mb-4">2. Information We Collect</h2>
            <p>We collect only information that is necessary to provide and improve our services.</p>
            ...
            <h3>2.2. Event & Planning Information</h3>
            <ul>
            ...
            <p>We use Google Places Autocomplete to help users select event locations. We do not store precise GPS location data unless entered by the user.</p>
            ...
            <p>We take reasonable technical and organisational measures to protect your information.</p>
            <ul>
            ...
            <p>Despite safeguards, no system is 100% secure.</p>

            <h2 className="text-2xl font-bold font-headline mt-8 mb-4">6. Third-Party Service Providers</h2>
            <p>We use trusted third-party services to operate SimpliPlan:</p>
            <ul>
              <li>Google Firebase – authentication, database, and hosting</li>
              <li>Google Maps & Places API – address autocomplete</li>
            </ul>
            <p>These providers process data in accordance with their own privacy policies and applicable laws.</p>

            <h2 className="text-2xl font-bold font-headline mt-8 mb-4">7. International Data Transfers</h2>
            <p>Some service providers may process data outside South Africa. Where this occurs, we ensure appropriate safeguards are in place as required by POPIA.</p>
            ...
            <p>To exercise your rights, contact us at <a href="mailto:privacy@simpliplan.africa">privacy@simpliplan.africa</a>.</p>

            <h2 className="text-2xl font-bold font-headline mt-8 mb-4">10. Cookies & Analytics</h2>
            <p>SimpliPlan uses essential cookies and similar technologies to:</p>
            <ul>
            ...
            <p>SimpliPlan is not intended for children under the age of 18. We do not knowingly collect personal information from children.</p>
            ...
            <p>If you have any questions or concerns about this Privacy Policy or how we handle your information, contact:</p>
