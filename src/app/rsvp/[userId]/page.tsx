 ...
 * This route helps bridge deep invitation links and ensures a clean URL hierarchy.
 */
export default function RsvpLanding({ params }: { params: { userId: string } }) {
  ...
  useEffect(() => {
    // Standard landing behavior: if no budgetId is present, we redirect to home
    // after a short delay to allow for background lookups or user feedback.
