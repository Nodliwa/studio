                    ...
                    <Sheet>
                        ...
                        <nav className="flex flex-col gap-6 text-lg font-medium mt-8">
                            ...
                            {user && !user.isAnonymous ? (
                                ...
                                <SheetClose asChild>
                                     <DialogTrigger asChild>
                                        <Button variant="outline" className="justify-start p-2 text-lg font-medium text-foreground/60 hover:text-foreground/80">
                                ...
                                <SheetClose asChild>
                                    <Link href="/profile" className="transition-colors hover:text-foreground/80 text-foreground/60 flex items-center">
